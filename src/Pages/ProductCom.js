...
export default function ProductCom() {
    ...
    let arr = [{ "_id": "60c67bdff5ee510015f3dda8", "name": "Havana special", "price": 599, "size": "Small", "image": "https://github.com/codersgyan/pizza-images/blob/main/1619798224663-303286145.png?raw=true", "createdAt": "2021-06-13T21:42:55.573Z" },
    ...
    { "_id": "60c67b47f5ee510015f3dda1", "name": "Chicken mushroom", "price": 799, "size": "Small", "image": "https://github.com/codersgyan/pizza-images/blob/main/1619798003389-788648576.png?raw=true", "createdAt": "2021-06-13T21:40:23.941Z" }, { "_id": "60c67b32f5ee510015f3dda0", "name": "Four cheese", "price": 1200, "size": "Medium", "image": "https://github.com/codersgyan/pizza-images/blob/main/1619798169571-671551234.png?raw=true", "createdAt": "2021-06-13T21:40:02.211Z" },
    ...
    return (
        <>
            <div className=''>
                <h2 className='list_heading' >  Product list </h2>

                <div className="item_cont">

                    {arr.map((x) => {

                        return <ProductItem key={x.id} name={x.name} image={x.image} size={x.size} link_id={x._id} price={x.price} />
                    })}
